...
import { useAuth } from "../RequiredAuth/AuthProvider";
      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          ...
          >
            <li>
              <Link
                to={user.role === "ADMIN" ? "/" : "/restaurants"}
                className={`block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent ${
                  isCurrentPath("/")|isCurrentPath("/restaurants") ? "text-blue-700" : ""
                }`}
              >
                {user.role === "ADMIN" ?"Home":"Restaurants"}
              </Link>
            </li>
            {user.role === "ADMIN" && (
              <>
                <li>
                  <Link
                    to={"/admin/tables"}
                    className={`block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent ${
                      isCurrentPath("/admin/tables") ? "text-blue-700" : ""
                    }`}
                  >
                    Tables
                  </Link>
                ...
                <li>
                  <Link
                    to={"/admin/waiters"}
                    className={`block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent ${
                      isCurrentPath("/admin/waiters") ? "text-blue-700" : ""
                    }`}
                  >
                    Waiters
                  </Link>
                ...
                <li>
                  <Link
                    to={"/admin/chefs"}
                    className={`block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent ${
                      isCurrentPath("/admin/chefs") ? "text-blue-700" : ""
                    }`}
                  >
                    Chefs
                  </Link>
